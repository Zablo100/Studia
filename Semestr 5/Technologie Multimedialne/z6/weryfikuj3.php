<?php session_start();
 ...
 $result = mysqli_query($link, "SELECT * FROM users6 WHERE username='$user'"); // wiersza, w którym login=login z formularza
