...
$current_user = $_SESSION['user'];
    ...
    $result = mysqli_query($connection, "SELECT idmt FROM filmtype WHERE name='$type'");
    ...
    if(like_match("%.mp4", $basenazwa)) {
        ...
        if (move_uploaded_file($_FILES["fileToUpload"]["tmp_name"], $target_file)) {
            ...
            $sql = "INSERT INTO film (title, director, idu, filename , subtitles, idmt) 
